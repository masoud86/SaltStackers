...
{
    public class IngredientSubCategories : Pagination
    {
        public IngredientSubCategories() : base("EditDateTime")
        {
        ...
        public List<IngredientSubCategoryDto> Items { get; set; }
    }

    public class IngredientSubCategoryFilters : Pagination
    {
        public IngredientSubCategoryFilters() : base("EditDateTime")
        {
        }
    }

    public class IngredientSubCategoryDto : UserLog, IValidatableObject
    {
    ...
    public class IngredientSubCategoryApi
    {
        public string Title { get; set; }
        ...
        public IngredientCategoryApi? IngredientCategory { get; set; }
    }
}
